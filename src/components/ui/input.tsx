    ...
    return (
      <div className="relative group w-full">
        <input
          type={type}
          className={cn(
            "flex h-9 w-full rounded-md border border-input bg-black/50 px-3 py-1 text-base shadow-sm transition-all duration-300 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-cyan-500 focus-visible:ring-0 focus-visible:shadow-[0_0_15px_#06b6d4] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
